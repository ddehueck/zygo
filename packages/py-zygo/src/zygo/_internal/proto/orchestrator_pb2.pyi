...
class PythonEnvBuilder(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    PYTHON_ENV_BUILDER_UNSPECIFIED: _ClassVar[PythonEnvBuilder]
    PYTHON_ENV_BUILDER_UV: _ClassVar[PythonEnvBuilder]
    PYTHON_ENV_BUILDER_CONDA: _ClassVar[PythonEnvBuilder]

class PythonSpecKind(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    PYTHON_SPEC_KIND_UNSPECIFIED: _ClassVar[PythonSpecKind]
    PYTHON_SPEC_KIND_REQUIREMENTS_TXT: _ClassVar[PythonSpecKind]
    PYTHON_SPEC_KIND_UV_LOCK: _ClassVar[PythonSpecKind]
    PYTHON_SPEC_KIND_POETRY_LOCK: _ClassVar[PythonSpecKind]
    PYTHON_SPEC_KIND_ENVIRONMENT_YAML: _ClassVar[PythonSpecKind]
...
PYTHON_ENV_BUILDER_UNSPECIFIED: PythonEnvBuilder
PYTHON_ENV_BUILDER_UV: PythonEnvBuilder
PYTHON_ENV_BUILDER_CONDA: PythonEnvBuilder
PYTHON_SPEC_KIND_UNSPECIFIED: PythonSpecKind
PYTHON_SPEC_KIND_REQUIREMENTS_TXT: PythonSpecKind
PYTHON_SPEC_KIND_UV_LOCK: PythonSpecKind
PYTHON_SPEC_KIND_POETRY_LOCK: PythonSpecKind
PYTHON_SPEC_KIND_ENVIRONMENT_YAML: PythonSpecKind
...
class RegisterWorkflowRequest(_message.Message):
    __slots__ = ("name", "content_hash", "channels", "jobs", "python_entrypoint")
    NAME_FIELD_NUMBER: _ClassVar[int]
    CONTENT_HASH_FIELD_NUMBER: _ClassVar[int]
    CHANNELS_FIELD_NUMBER: _ClassVar[int]
    JOBS_FIELD_NUMBER: _ClassVar[int]
    PYTHON_ENTRYPOINT_FIELD_NUMBER: _ClassVar[int]
    name: str
    content_hash: str
    ...
    def __init__(self, name: _Optional[str] = ..., content_hash: _Optional[str] = ..., channels: _Optional[_Iterable[_Union[ChannelSchema, _Mapping]]] = ..., jobs: _Optional[_Iterable[_Union[JobSchema, _Mapping]]] = ..., python_entrypoint: _Optional[_Union[PythonEntrypoint, _Mapping]] = ...) -> None: ...
...
class JobSchema(_message.Message):
    __slots__ = ("name", "content_hash", "input_channel_name", "output_channel_names", "python_job_entrypoint")
    NAME_FIELD_NUMBER: _ClassVar[int]
    CONTENT_HASH_FIELD_NUMBER: _ClassVar[int]
    INPUT_CHANNEL_NAME_FIELD_NUMBER: _ClassVar[int]
    OUTPUT_CHANNEL_NAMES_FIELD_NUMBER: _ClassVar[int]
    PYTHON_JOB_ENTRYPOINT_FIELD_NUMBER: _ClassVar[int]
    name: str
    content_hash: str
    input_channel_name: str
    output_channel_names: _containers.RepeatedScalarFieldContainer[str]
    python_job_entrypoint: PythonJobEntrypoint
    def __init__(self, name: _Optional[str] = ..., content_hash: _Optional[str] = ..., input_channel_name: _Optional[str] = ..., output_channel_names: _Optional[_Iterable[str]] = ..., python_job_entrypoint: _Optional[_Union[PythonJobEntrypoint, _Mapping]] = ...) -> None: ...

class PythonJobEntrypoint(_message.Message):
...
class PythonEntrypoint(_message.Message):
    __slots__ = ("project_root_dir", "relative_module_path", "workflow_object_attr", "env_builder", "relative_spec_path", "spec_kind", "python_version")
    PROJECT_ROOT_DIR_FIELD_NUMBER: _ClassVar[int]
    RELATIVE_MODULE_PATH_FIELD_NUMBER: _ClassVar[int]
    WORKFLOW_OBJECT_ATTR_FIELD_NUMBER: _ClassVar[int]
    ENV_BUILDER_FIELD_NUMBER: _ClassVar[int]
    RELATIVE_SPEC_PATH_FIELD_NUMBER: _ClassVar[int]
    SPEC_KIND_FIELD_NUMBER: _ClassVar[int]
    PYTHON_VERSION_FIELD_NUMBER: _ClassVar[int]
    project_root_dir: str
    relative_module_path: str
    workflow_object_attr: str
    env_builder: PythonEnvBuilder
    relative_spec_path: str
    spec_kind: PythonSpecKind
    python_version: str
    def __init__(self, project_root_dir: _Optional[str] = ..., relative_module_path: _Optional[str] = ..., workflow_object_attr: _Optional[str] = ..., env_builder: _Optional[_Union[PythonEnvBuilder, str]] = ..., relative_spec_path: _Optional[str] = ..., spec_kind: _Optional[_Union[PythonSpecKind, str]] = ..., python_version: _Optional[str] = ...) -> None: ...

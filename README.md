# Zygo - A modern workflow management system for bioinformatics in Python

**🚨 Zygo is an active work in progress. Do not use it in production.**

Zygo aims to deliver a powerful workflow management system with a great developer experience for bioinformatics.

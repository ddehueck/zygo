...
//! # Shape of the module
//!
//! Each domain entity has a generator describing the bounded input space from
//! which it can be drawn. The generators compose into a resolved workflow schema
//! and its candidate input data references, ready to pass directly to `Zygo`.

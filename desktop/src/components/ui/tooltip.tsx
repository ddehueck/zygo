...
function TooltipContent({
  ...
  return (
    <TooltipPrimitive.Portal>
      ...
      >
        {children}
        <TooltipPrimitive.Arrow className="fill-popover z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px] [&>polygon]:[stroke-width:1px] [&>polygon]:[stroke:hsl(var(--border))]" />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  );
}
